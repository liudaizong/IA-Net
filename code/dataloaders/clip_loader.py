...
def get_dataset(dataset, feature_path, data_path, word2vec, max_num_frames, max_num_words, max_num_nodes,
    ...
    if dataset == 'ActivityNet':
        ...
        return ClipDataset3(feature_path, data_path, word2vec, max_num_frames, max_num_words, max_num_nodes,
                            is_training)
    elif dataset == 'Didemo':
        return ClipDataset4(feature_path, data_path, word2vec, max_num_frames, max_num_words, max_num_nodes,
                            is_training)
    return None
